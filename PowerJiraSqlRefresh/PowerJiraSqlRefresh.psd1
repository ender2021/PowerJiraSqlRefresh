#
# Module manifest for module 'PowerJiraSqlRefresh'
#
#
...
RootModule = 'PowerJiraSqlRefresh.psm1'
...
GUID = '5d5034e7-06ce-4986-896a-1b9d86f06f6a'
...
FormatsToProcess = 'PowerJiraSqlRefresh.Format.ps1xml'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("Jira","Atlassian","REST", "SQL")

        # A URL to the license for this module.
        # LicenseUri = ''

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/ender2021/PowerJiraSqlRefresh'
